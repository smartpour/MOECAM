...
if __name__ == "__main__":
    ...
    np.savetxt('sphere_objectives.txt', F1, header='f1 f2 (sphere)')
    np.savetxt('zdt1_objectives.txt', F2, header='f1 f2 (ZDT1)')
    np.savetxt('kursawe_objectives.txt', F3, header='f1 f2 (Kursawe)')

    print(f"\n=== Saved objective values to .txt files ===")
