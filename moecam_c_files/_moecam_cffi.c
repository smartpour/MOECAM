...
/*  4 */ _CFFI_OP(_CFFI_OP_FUNCTION, 6), // int()(double *, int, int, double *, int, int)
...
static const struct _cffi_global_s _cffi_globals[] = {
  ...
  { "extract_pareto_front", (void *)_cffi_f_extract_pareto_front, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 4), (void *)_cffi_d_extract_pareto_front },
  { "extract_pareto_indices", (void *)_cffi_f_extract_pareto_indices, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 12), (void *)_cffi_d_extract_pareto_indices },
  { "print_message", (void *)_cffi_f_print_message, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_O, 20), (void *)_cffi_d_print_message },
};
